...
export const translations: Translations = {
  ...
  "about.p1": { id: "Selama saya berkuliah di program studi Teknik Informatika Universitas Maritim Raja Ali Haji, saya mendedikasikan waktu mendalami rekayasa perangkat lunak (software engineering). Tidak sekadar teori, saya aktif merancang proyek web modern dan AI, mulai dari e-commerce interaktif hingga sistem deteksi tumpahan minyak (sludge oil) berbasis Deep Learning menggunakan citra satelit.", en: "During my studies in the Informatics Engineering program at Raja Ali Haji Maritime University, I dedicated my time to software engineering. Beyond classroom theories, I actively designed modern web and AI projects, from interactive e-commerce platforms to Deep Learning-based sludge oil detection systems using satellite imagery." },
  "about.p2": { id: "Saya percaya bahwa kode yang baik harus diseimbangkan dengan desain antarmuka yang ramah pengguna serta arsitektur database yang efisien. Oleh karena itu, saya selalu menantang diri untuk menguasai alur pengembangan secara end-to-end, mulai dari pemodelan relasi data di backend hingga implementasi interaksi mikro yang halus di frontend.", en: "I believe that good code must be balanced with user-friendly interface design and efficient database architecture. Therefore, I always challenge myself to master the end-to-end development flow, from data relation modeling on the backend to smooth micro-interactions on the frontend." },
  "about.p3": { id: "Bagi saya, teknologi adalah alat untuk memecahkan masalah nyata. Saya selalu antusias mengeksplorasi teknologi modern seperti React, TypeScript, Laravel, FastAPI, dan Docker untuk memastikan setiap sistem digital yang saya bangun efisien, aman, dan siap menjawab tantangan industri.", en: "For me, technology is a tool to solve real-world problems. I am always eager to explore modern technologies like React, TypeScript, Laravel, FastAPI, and Docker to ensure every digital system I build is efficient, secure, and ready for industry challenges." },
  ...
  "experience.microsoftCertTitle": { id: "Sertifikat Microsoft", en: "Microsoft Certificate" },
  "experience.microsoftCertDesc": { id: "Sertifikat proyek akhir Microsoft 'Full-Stack Developer Capstone Project' via Coursera (Juni 2026)", en: "Microsoft 'Full-Stack Developer Capstone Project' course certificate via Coursera (June 2026)" },
