...
export const translations: Translations = {
  ...
  "about.p2": { id: "Pengalaman terbesar yang saya dapatkan adalah saat kerja praktik selama 2 bulan di Kejaksaan Tinggi Kepulauan Riau. Saya berkontribusi membangun DASKRIMTI (Dashboard Kriminalitas Terpadu), sistem terpadu CMS perkara dan absensi pegawai berbasis Supabase, serta berkesempatan mempresentasikannya langsung di hadapan tim Kejaksaan.", en: "My greatest experience was during a 2-month practical work program (kerja praktik) at the High Prosecution Office of Riau Islands. I contributed to building DASKRIMTI (Integrated Criminality Dashboard), a Supabase-based case CMS and mobile attendance system, and presented it directly to the Prosecution team." },
  "about.p3": { id: "Bagi saya, perkuliahan adalah wadah terbaik untuk bereksperimen. Saya selalu antusias mempelajari teknologi baru seperti React, TypeScript, Laravel, FastAPI, dan Docker untuk memastikan setiap sistem digital yang saya bangun efisien, aman, serta siap menjawab tantangan industri.", en: "For me, university is the ultimate playground for experimentation. I am always eager to learn modern technologies like React, TypeScript, Laravel, FastAPI, and Docker to ensure every digital system I build is efficient, secure, and ready for industry challenges." },
