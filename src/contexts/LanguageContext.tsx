...
export const translations: Translations = {
  ...
  "about.p1": { id: "Selama menempuh perkuliahan Teknik Informatika di Universitas Maritim Raja Ali Haji, saya mendedikasikan sebagian besar waktu saya untuk mendalami rekayasa perangkat lunak (software engineering). Saya tidak hanya mempelajari teori di kelas, tetapi aktif mempraktikkannya dengan merancang berbagai proyek web modern dan kecerdasan buatan—seperti aplikasi e-commerce interaktif hingga sistem deteksi tumpahan minyak (sludge oil) berbasis Deep Learning menggunakan citra satelit.", en: "While pursuing my Informatics Engineering degree at Raja Ali Haji Maritime University, I dedicated most of my time to mastering software engineering. Beyond classroom theories, I actively built modern web and AI applications—ranging from interactive e-commerce platforms to Deep Learning-based sludge oil detection systems using satellite imagery." },
  "about.p2": { id: "Pengalaman praktis terbesar saya dapatkan saat menjalani kerja praktik selama 2 bulan di Kejaksaan Tinggi Kepulauan Riau. Di sana, saya berkontribusi langsung membangun DASKRIMTI (Dashboard Kriminalitas Terpadu)—sebuah sistem terpadu yang mencakup CMS data perkara dan dashboard absensi pegawai berbasis Supabase—serta berkesempatan mempresentasikan sistem ini secara langsung di hadapan tim Kejaksaan.", en: "My most valuable hands-on experience came from a 2-month practical work program (kerja praktik) at the High Prosecution Office of Riau Islands. I contributed directly to building DASKRIMTI (Integrated Criminality Dashboard)—a unified system featuring a case CMS and mobile attendance dashboard integrated with Supabase—and had the opportunity to present this system directly to the Prosecution team." },
  "about.p3": { id: "Bagi saya, bangku perkuliahan adalah wadah terbaik untuk bereksperimen. Saya selalu antusias mengeksplorasi dan mempelajari teknologi terbaru seperti React, TypeScript, Laravel, FastAPI, hingga Docker, demi memastikan setiap solusi digital yang saya bangun efisien, aman, dan siap menjawab tantangan di industri.", en: "For me, university has been the ultimate playground for experimentation. I am always enthusiastic about exploring and learning modern technologies like React, TypeScript, Laravel, FastAPI, and Docker to ensure every digital solution I build is efficient, secure, and ready to meet industry challenges." },
