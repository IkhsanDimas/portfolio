...
export const translations: Translations = {
  ...
  "about.p2": { id: "Saya berfokus pada keseimbangan antara desain antarmuka yang intuitif di frontend dan struktur database yang efisien di backend. Hal ini membantu saya menguasai alur pengembangan aplikasi secara menyeluruh.", en: "I focus on the balance between intuitive frontend interface design and efficient backend database structure. This helps me master the application development flow comprehensively." },
  "about.p3": { id: "Bagi saya, teknologi adalah alat pemecah masalah. Saya selalu berupaya menerapkan standar industri modern untuk memastikan setiap sistem yang dibangun aman, efisien, dan andal.", en: "For me, technology is a problem-solving tool. I always strive to apply modern industry standards to ensure every system built is secure, efficient, and reliable." },
